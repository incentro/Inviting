...
public class MailISendO extends DbAbstract {
...
///////////////////***************************verstuur de mail*************************/////////////////////
    	...
    	message = message.replaceAll( "\\{link\\}" , mail.getLink());
    	 ...
    	 for (ContactZoho c : aContacts) {
    		 ...
    		 if(single){
    			 ...
    			 oIo. insertOpmerking( id ,  datum,  opmerking, opmerking_contact  ,  eventIDs);
    			 System.out.println(c.getVoornaam() + " " + c.getAchternaam());
    		}
    		 } else {
	    		 SendMail(ml.getEmail(),ml.getEmail(), ml.getPass(),  onderwerp, c.getMail(), m);
	    		 oIo. insertOpmerking( c.getId() ,  datum,  opmerking, opmerking_contact  ,  eventIDs);
	    		 System.out.println(c.getVoornaam() + " " + c.getAchternaam());
    		 }
    ...
    public String SendMail(String from, String useru, String passw, String subject, String receiver, String msg) {
